...
export function createPropertyCard(property) {
  ...
  divGridAreas.appendChild(
    imagesLinksButtons(property.link, property.imageUrl)
  );
  divGridAreas.appendChild(
    ratingAndIcon(property.rating, property.numOfReviews)
  );
  divGridAreas.appendChild(
    descriptionCard(property.propSize, property.location, property.description)
  );
  divGridAreas.appendChild(
    ppNightAndTotal(property.pricePerNight, property.priceTotal)
  );
